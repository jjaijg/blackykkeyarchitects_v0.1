          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-500 hover:text-gray-100">Home</a>
                </li>
                <li>
                  <a className="text-gray-500 hover:text-gray-100">Services</a>
                </li>
                <li>
                  <a className="text-gray-500 hover:text-gray-100">Projects</a>
                </li>
                <li>
                  <a className="text-gray-500 hover:text-gray-100">Get a quote</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
