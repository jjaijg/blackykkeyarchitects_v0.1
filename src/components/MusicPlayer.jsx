...
function MusicPlayer() {
  return (
    <div className="MusicPlayer flex flex-col px-5 w-full border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
      <div className="upperPart flex items-center justify-between">
        <div className="profile flex">
          <img
            src={require("../assets/images/Mask Group 23.png")}
            alt=""
            className="w-10 h-10 border-2 border-white rounded-full"
          />
          <div className="details flex flex-col ml-4">
            <span className="text-base">Jai Ganesh</span>
      ...
      <div className="lowerPart fex items-center justify-between mt-5">
        <div className="track flex justify-between text-sm text-gray-500 flex-[2] items-center">
          <span>2: 30</span>
          <img
            src={require("../assets/images/Group 9.png")}
            alt=""
            className="w-64"
          />
          <span>4: 30</span>
